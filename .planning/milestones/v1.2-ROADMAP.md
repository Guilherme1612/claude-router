...
- [x] 20-04-PLAN.md — Close CR-01: reset `recovered` per reconcile + fix line-337 knownGood initializer + multi-reconcile regression test (depends on 20-02)
- [x] 20-05-PLAN.md — Close CR-02a + CR-02b: promote sufficiency gate + rollback_reason='canary_rollback' param + 2 regression tests (depends on 20-03)
