...
- [x] 06-01-PLAN.md — Wave 0 inspect/preview/explain-last tests.
- [x] 06-02-PLAN.md — Shared dry-run `inspectDecision` helper.
- [x] 06-03-PLAN.md — `router inspect` and `router preview` commands.
- [x] 06-04-PLAN.md — Privacy-preserving `router explain-last`.
- [x] 06-05-PLAN.md — INS-04 completeness and calibration alignment.
...
- [x] 07-01-PLAN.md — Wave 1 health/routes/unmapped/coverage contract tests.
- [x] 07-02-PLAN.md — Shared coverage and target diagnostic helper exports.
- [x] 07-03-PLAN.md — `router routes` and `router unmapped` commands.
- [x] 07-04-PLAN.md — `router coverage` and `router doctor` commands.
- [x] 07-05-PLAN.md — Final regression, calibration, and perf gates.
...
- [x] 09-01-PLAN.md — Wave 0 failing-first validation for evolution visibility and proposal privacy/non-mutation.
- [x] 09-02-PLAN.md — Evolution visibility in doctor and inspect/preview output.
- [x] 09-03-PLAN.md — Wave 2 read-only advisory proposal mode for telemetry misses.
...
- [x] 10-01-PLAN.md — Hot-path safety release matrix for fail-open, latency, no-classifier, and operator-boundary gates.
- [x] 10-02-PLAN.md — Pending.
- [x] 10-03-PLAN.md — Pending.
...
| 6. Inspect and Preview Commands | v1.1 | 5/5 | Complete | 2026-07-10 |
| 7. Health, Routes, Unmapped, and Coverage Utilities | v1.1 | 5/5 | Complete | 2026-07-10 |
| 8. Codebase Routing Calibration | v1.1 | 3/3 | Complete   | 2026-07-11 |
| 9. Telemetry Evolution Visibility | v1.1 | 3/3 | Complete    | 2026-07-11 |
| 10. Safety, Coexistence, and Release Gates | v1.1 | 3/3 | Complete    | 2026-07-14 |
