...
- 🚧 **v1.8 Adaptive Semantic Routing and Continuity** — Phases 50-55 (planned)
...
### 🚧 v1.8 Adaptive Semantic Routing and Continuity (Planned)
...
- [ ] **Phase 54: Independent Evaluation and Hot-Path Budgets** - Measure every mandatory quality and production-path budget independently against a matched baseline.
- [ ] **Phase 55: Installer, Native Parity, and Release Truth** - Prove owned lifecycle behavior, installed native Claude/Codex parity, recovery, and complete release evidence.
...
| 54. Independent Evaluation and Hot-Path Budgets | v1.8 | 0/TBD | Not started | - |
| 55. Installer, Native Parity, and Release Truth | v1.8 | 0/TBD | Not started | - |
