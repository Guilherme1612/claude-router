...
export const EVALUATION_VERSION = 'v1.8-evaluation-v1';
...
export const V17_BASELINE = Object.freeze({
...
export function runEvaluation({ runtime = 'claude', candidate_status = 'accepted', now = Date.now() } = {}) {
  ...
  const performanceReport = {
    ...
    cold, warm, startup_latency_ms: { cold: startupLatency }, artifact_bytes: artifactBytes, context_bytes: route.bounds.context_bytes, tool_calls: route.bounds.tool_calls, baseline: V17_BASELINE,
