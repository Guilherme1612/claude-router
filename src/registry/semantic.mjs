...
export const SEMANTIC_WORKFLOWS = Object.freeze([
  ...
  Object.freeze({
    workflow_id: 'quality-audit', goal: 'audit',
    subjects: Object.freeze(['codebase']),
    operations: Object.freeze(['inspect', 'audit', 'review', 'verify']),
    roles: Object.freeze(['audit', 'inspection']),
    aliases: Object.freeze(['repository quality audit', 'codebase quality review']),
    evidence_needs: Object.freeze(['audit', 'report', 'tests']), max_capabilities: 3,
  }),
  Object.freeze({
    workflow_id: 'feature-build', goal: 'build',
    subjects: Object.freeze(['codebase', 'feature']),
    operations: Object.freeze(['build', 'implement', 'test']),
    roles: Object.freeze(['planning', 'implementation', 'testing']),
    aliases: Object.freeze(['build a feature', 'implement repository change']),
  ...
  Object.freeze({
    ...
    roles: Object.freeze(['diagnosis', 'implementation', 'testing']),
    aliases: Object.freeze(['diagnose and fix a bug', 'repair repository defect']),
    evidence_needs: Object.freeze(['diagnosis', 'tests', 'report']), max_capabilities: 3,
  }),
  Object.freeze({
    workflow_id: 'refactor-optimization', goal: 'refactor-optimize',
    subjects: Object.freeze(['codebase', 'module', 'performance']),
    operations: Object.freeze(['refactor', 'optimize', 'benchmark', 'verify']),
    roles: Object.freeze(['refactor', 'optimization', 'testing']),
    aliases: Object.freeze(['refactor and optimize', 'improve code structure']),
    evidence_needs: Object.freeze(['benchmark', 'tests', 'report']), max_capabilities: 3,
  }),
  Object.freeze({
    workflow_id: 'design-review', goal: 'design-review',
    subjects: Object.freeze(['ui', 'interface']),
    operations: Object.freeze(['review', 'audit', 'verify']),
    roles: Object.freeze(['design-review', 'usability']),
    aliases: Object.freeze(['review interface design', 'audit user experience']),
    evidence_needs: Object.freeze(['design', 'review', 'report']), max_capabilities: 2,
  }),
  Object.freeze({
    workflow_id: 'browser-interaction-verification', goal: 'browser-verify',
    subjects: Object.freeze(['browser', 'interface', 'web']),
    operations: Object.freeze(['interact', 'verify', 'test']),
    roles: Object.freeze(['browser-verification']),
    aliases: Object.freeze(['verify a browser flow', 'test website interaction']),
    evidence_needs: Object.freeze(['browser', 'screenshots', 'report']), max_capabilities: 2,
  }),
  Object.freeze({
    workflow_id: 'coordinator-workflow', goal: 'coordinate',
    subjects: Object.freeze(['codebase', 'feature', 'interface', 'browser']),
    operations: Object.freeze(['audit', 'build', 'diagnose', 'fix', 'refactor', 'review', 'verify']),
    roles: Object.freeze(['coordination']),
    aliases: Object.freeze(['coordinate repository work', 'manage multiple task outcomes']),
    evidence_needs: Object.freeze(['report']), max_capabilities: 8,
  }),
]);
