...
- [ ] **Phase 38: Cross-Runtime Native Feasibility** - Prove truthful native dispatch, observation, protected-effect pause, startup delivery, and performance in Claude and Codex.
...
**Plans**: 3 plans
Plans:
- [ ] 38-01-PLAN.md — Claude native dispatch tracer (HOST-01): contract + receipt store + Claude adapter + harmless fixture + off-hot-path trigger + anti-cheat test
- [ ] 38-02-PLAN.md — Codex adapter + parity + recommendation-only fallback (HOST-02, HOST-03)
- [ ] 38-03-PLAN.md — Prompt/startup latency + token budget invariants + deploy bundle update (HOST-04)
...
|-------|-----------|----------------|--------|-----------|
| 38. Cross-Runtime Native Feasibility | v1.6 | 0/TBD | Not started | - |
